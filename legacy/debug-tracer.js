...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log(
    ...
    darkModeToggle ? "✅ EXISTS" : "❌ MISSING",
  );
  console.log(
    "  - #notifications element:",
    notifications ? "✅ EXISTS" : "❌ MISSING",
  );
  ...
  console.log(
    ...
    typeof window.DashboardAuth !== "undefined" ? "✅ LOADED" : "❌ MISSING",
  );
  console.log(
    "  - window.pdfjsLib:",
    typeof window.pdfjsLib !== "undefined" ? "✅ LOADED" : "❌ MISSING",
  );
  ...
  console.log(
    "  - Body background:",
    backgroundImage || backgroundColor || "DEFAULT",
  );
  console.log(
    "  - Faith gradient applied:",
    backgroundImage.includes("gradient") ? "✅ YES" : "❌ NO",
  );
