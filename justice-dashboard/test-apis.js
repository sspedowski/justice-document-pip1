...
async function runTests() {
  ...
  results.push(
    await testAPI('Wolfram Alpha LLM API', `${BASE_URL}/api/wolfram-test`, {
      method: 'POST',
  ...
  results.push(
    await testAPI('Batch Wolfram Analysis', `${BASE_URL}/api/batch-analyze`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        queries: batchQueries,
        analysisType: 'legal-timeline',
      }),
    })
  );
