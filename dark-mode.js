...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!darkModeToggle) {
        console.warn('Dark mode toggle button (#darkModeToggle) not found in DOM. Skipping dark mode initialization.');
        return;
    }
    ...
    console.log('Dark mode initialized successfully. Current theme:', savedTheme || 'light');
});
