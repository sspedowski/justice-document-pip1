...
document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log(
    "🔍 Dark Mode Toggle:",
    darkModeToggle ? "✅ Found" : "❌ Missing",
  );

  // Check for required global objects
  console.log(
    "🔍 DashboardAuth:",
    typeof window.DashboardAuth !== "undefined" ? "✅ Available" : "❌ Missing",
  );
  ...
  if (app) {
    ...
    testDiv.innerHTML =
      '<h2 style="color: #BA9930; text-align: center;">🎯 DIAGNOSTIC: Dashboard Loading Test</h2>';
