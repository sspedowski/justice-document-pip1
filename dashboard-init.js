...
window.addEventListener('DOMContentLoaded', function() {
  ...
  setTimeout(function() {
    ...
    console.log('checkAuth method exists?', typeof DashboardAuth !== 'undefined' && typeof DashboardAuth.checkAuth === 'function');
    ...
    if (typeof DashboardAuth !== 'undefined' && DashboardAuth.checkAuth) {
      ...
      try {
        ...
        if (typeof DashboardAuth !== 'undefined' && DashboardAuth.showLoginForm) {
          DashboardAuth.showLoginForm();
        }
      }
    } else {
